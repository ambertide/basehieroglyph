...
test.each([
  [[0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF], [0x2AA, 0x3BC, 0x337, 0x1EE, 0x3FC, 0x00, 0x0, 0x0]],
  [[0xAA, 0xBB, 0xCC], [0x2AA, 0x3BC, 0x300, 0x000]],
  [[0xBB, 0xCC], [0x2EF, 0x0C0, 0x000, 0x000]],
  [[0xCC], [0x330, 0x0, 0x0, 0x0]]
